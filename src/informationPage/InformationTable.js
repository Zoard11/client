        ...
        <div>
            ...
            <Table data={ingredients} />
                ...
                <ul className="pagination justify-content-center">
                    ...
                    <button className="page-link" onClick={firstButton}>First</button>
                    </li>
                    
                    
                    {currentPage>1 && (
                        <li className="page-item ">
                        <button className="page-link" onClick={previousButton} >Previous</button>
                        </li>
                    )}   
                    {currentPage>3 && (
                        <li className="page-item ">
                    ...
                    {currentPage!==lastPage && (
                       <li className="page-item">
                       <button className="page-link" onClick={nextButton}>Next</button>
                       </li>
                    )}  
                    
                    <li className="page-item">
                    <button className="page-link" onClick={lastButton}>Last</button>
                    </li>
                </ul>
